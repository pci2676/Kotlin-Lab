...
data class CircuitBreakerProperties(
    ...
    var slowCallDuration: Int = CircuitBreakerConfig.DEFAULT_SLOW_CALL_DURATION_THRESHOLD, // 이 값보다 늦은 시간으로 호출이 이루어지면 늦은 호출로 간주한다.
    ...
    @field:NotNull
    var minimumNumberOfCalls: Int? = null, // 실패비율, 느린호출 비율의 단위 호출수
